...
class PrivacyReviewer:
    ...
    _STOPWORDS = {
        "carl", "alex", "bob", "luna", "的", "是", "在", "了", "和", "有",
        "不", "人", "都", "一", "到", "会", "上", "这", "个", "他", "她",
        "我", "你", "他们", "我们", "与", "也", "就", "但", "对", "把",
        "去", "来", "很", "要", "能", "可以", "没有", "所以", "因为",
        "如果", "from", "the", "and", "for", "with", "that", "this",
        "not", "are", "was", "has", "have", "been", "will",
    }
