...
HAS_API_KEY = bool(os.environ.get("MEMGATE_API_KEY"))
API_KEY = os.environ.get("MEMGATE_API_KEY", "")
API_BASE = os.environ.get("MEMGATE_API_BASE", "https://api.openai.com/v1")

skip_no_api = pytest.mark.skipif(not HAS_API_KEY, reason="MEMGATE_API_KEY not set")
